...
# Comment: I succesfully retrieve all info from every movie, but I got stuck on 
# returning this info. If multiple (e.g. multiple directors), I store it
# in a list directors[], but I get an error with ' .encode ' attribute, which is from
# code I didn't write...
'''
